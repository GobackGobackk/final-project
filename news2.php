...
<div id="main" class="background">
  ...
  <div id="right">
    <p class="fb ct">News</p>
      <table class="all">
        <tbody>
          <tr>
            <td class="tt ct">タイトル</td>
            <td class="pp">┗|∵|┓『HoneyWorks Premium Live（ハニプレ）』公式Twitterフォロワー数82,800人突破記念！</td>
          </tr>
          <tr>
            <td class="tt ct">内容</td>
            <td class="pp">HoneyWorks初のスマートフォン向け公式リズムゲーム、『HoneyWorks Premium Live（ハニプレ）』の公式Twitterのフォロワー数が82,800（ハニワ）人を突破しました！<br>
沢山のフォローありがとうございます┗|∵|┓<br>
感謝の気持ちを込めて、クマパンの後輩の「オリジナルTwitterアイコン」を配布いたします。<br>
こちらの画像を保存し、ぜひ使ってね┗|∵|┓<br>
また、クマパンの後輩の名前をTwitterにて募集するキャンペーンを12月20日（金）まで開催中です。<br>
HoneyWorks Premium Live公式Twitterアカウント（@HoneyWorks_Game）をフォローし、「＃後輩の名前」でたくさんツイートしてね┗|∵|┓</td>
          </tr>
        </tbody>
      </table>
      <div class="ct">
        <button class="bu"><a href="news.php">return</a></button>
      </div>
      <div class="j"><img src="12.png"></div>
    </div>   
  </div>
