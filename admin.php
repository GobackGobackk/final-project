...
if(!isset($_SESSION["membername"]) || ($_SESSION["membername"]=="")){
  if(isset($_POST["username"]) && isset($_POST["passwd"])){
    ...
    $username = "mis";
    $passwd = "999";
    //¤ñ¹ï±b¸¹±K½X¡A­Yµn¤J¦¨¥\«h§e²{µn¤Jª¬ºA
...
<div id="main" class="background">
  ...
  <div id="left" class="ct">
    ...
    <div id="right">
      <p class="fb">管理登入</p>
 <table class="all"> 
<form action="aC.php" method="post" name="formAdmin" id="formAdmin">
   <tr>
   ...
   <tr>
     ...
     <td class="pp"><input type="password" name="passwd" id="passwd"></td>
   </tr>
  

 </table>

 <div class="ct"><input type="submit" name="button" id="button" value="Login" /></div>
 </div>
</form>
